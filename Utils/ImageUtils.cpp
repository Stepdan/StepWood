...
cv::Mat adjustChannelsOrder(const cv::Mat &srcMat, Utils::MatColorOrder srcOrder, Utils::MatColorOrder targetOrder)
{
...
Utils::MatColorOrder getColorOrderOfRGB32Format()
{
#if Q_BYTE_ORDER == Q_LITTLE_ENDIAN
	    return Utils::MatColorOrder::MCO_BGRA;
#else
	    return Utils::MatColorOrder::MCO_ARGB;
#endif
}
