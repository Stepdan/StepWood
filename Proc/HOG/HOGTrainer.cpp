...
//    _cellSize(cell_size), _nbins(nbins), _norma(norma), _L2hysThreshold(threshold_L2hys),
//    _rtrees(cv::ml::RTrees::create())
//{
//    initLUT();
//}
...
//        else
//        {
//            CV_Error(cv::Error::StsBadArg,"Norma mast be L1, L2 ore L2Hys");
//        }
...
//    Ptr<HOG::MemoryManager> memoryManager( new MemoryManager( this, img, cv::Size() ) );
...
//                cv::ml::RTrees* rtrees,vector<bool>* findRect,vector<cv::Rect>* rects,vector<float>* tempWeights)
//    {
//        _wins = &wins;
//        _nblocks = nblocks;
...
//                    _findRect->at(r) = true;
//                    //_tempWeights->at(r) = _rtrees->predict(descr);
...
//    }
//    win_stride = Size(std::gcd(win_stride.width, _hogPtr->_blockStride.width),
//                    std::gcd(win_stride.height, _hogPtr->_blockStride.height));
