...
public:
    ...
    void detectMultiScale(Mat& img, std::vector<Rect>& foundLocations, std::vector<float>& foundWeights);

    void loadRTrees(const std::string& filename, const std::string& name);
